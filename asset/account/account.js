...
// ================= API =================
const API = "https://script.google.com/macros/s/AKfycbzT8ZOgSjJBFtSnZKPsLPb--5GUWKN8bKWna_o_pebNr98MDLNKfGUnin8KlerUNEv7/exec";
...
Type DELETE to confirm.
  ...
  try {
    ...
    showToast("Deleting business...", "info");
...
async function saveCustomer(event) {
  ...
  const lang = document.getElementById("custLang")?.value || "en";
  ...
  try {
    ...
    console.log("📩 Sending Invite with Lang:", lang);
