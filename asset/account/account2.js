...
// ================= API =================
const API = "https://script.google.com/macros/s/AKfycbwMrILVYjbGANykF0bA1JEvFLY6HorevQUOO89bZVBzzVblgpjUCfOLqwiqt0G3H48P/exec";
...
function getTxnIcon(note = "") {
  ...
  if (
    ...
    note.includes("tablet") ||
    note.includes("doctor") ||
    note.includes("hospital") ||
    note.includes("pharmacy") ||
    note.includes("clinic")
  ) return "💊";
  ...
  // =========================
  if (
    note.includes("recharge") ||
    note.includes("mobile") ||
    note.includes("jio") ||
    note.includes("airtel") ||
    note.includes("vi") ||
    note.includes("bsnl")
  ) return "📱";
  ...
  if (
    note.includes("rent") ||
    note.includes("house") ||
    note.includes("eb bill") ||
    note.includes("current bill")
  ) return "🏠";
  ...
  if (
    note.includes("fee") ||
    note.includes("school") ||
    note.includes("college")
  ) return "🎓";
